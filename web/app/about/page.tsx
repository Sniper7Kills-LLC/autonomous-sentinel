      ...
      <main className={styles.main}>
        ...
        <Section num="01" title="What this site catalogues" eyebrow="Mission">
          <p>
            ...
            software-defined radios that auto-capture broadcasts and upload them to the pipeline.
            The pipeline transcribes the audio, parses each transmission into a structured record,
            and publishes the result for community validation.
          </p>
          <p>
          ...
          <Alert tone="info" title="What we are not">
            We are not affiliated with the U.S. Department of Defense, the U.S. Air Force,
            USSTRATCOM, or any other government agency. EAM broadcasts are
            unencrypted-yet-cryptographically-authenticated transmissions in the open radio
            spectrum. Cataloguing them is entirely lawful in the United States, where the project
            and its volunteers operate.
          </Alert>
        </Section>
        ...
        <Section num="02" title="HFGCS, in one paragraph" eyebrow="Context">
          <p>
            ...
            used to pass orders to nuclear-capable forces and to coordinate the strategic command
            and control network. It is operated from <strong>Mainsail</strong> &mdash; a rotating
            net-control station &mdash; and uses a small set of public frequencies in the HF band,
            most notably <code>11.175 USB</code>, <code>8.992 USB</code>, <code>15.016 USB</code>,
            and <code>4.724 USB</code>. Anyone with a receiver tuned to those frequencies can hear
            the broadcasts; what&rsquo;s broadcast is encrypted in cipher form, not in transmission
            form.
          </p>
        </Section>
        ...
        <Section num="03" title="Message types" eyebrow="Taxonomy">
          ...
          <ul className={styles.typeList}>
            ...
            <li>
              ...
              traffic &mdash; a message from this site&rsquo;s administrators to operators and
              viewers (maintenance windows, policy updates, etc.).
            </li>
            <li>
            ...
            <li>
              <MessageTypeBadge type="OTHER" /> <strong>Other.</strong> Anything that didn&rsquo;t
              fit a template above.
            </li>
          </ul>
        </Section>
        ...
        <Section num="04" title="EAM format" eyebrow="ALL STATIONS">
          ...
          <p>
            <strong>30 characters total is the most common length</strong>, but it is not a hard
            rule. 28 and 22 are also routine; longer messages do happen and run into the hundreds.
            Whenever the broadcast is <em>not</em> the default 30, the transmitter explicitly
            announces the count: <q>Message of forty-two characters follows</q>. Our UI tags each
            message with its actual character count so the difference is visible at a glance.
          </p>

          <h3 className={styles.h3}>Character set</h3>
          <p>
            EAM bodies are alphanumeric but practice excludes the digits <code>0</code>,{' '}
            <code>1</code>, <code>8</code>, and <code>9</code> &mdash; these are ambiguous when
            spoken under HF conditions. Any transcribed body containing those digits is flagged as
            suspect for community review.
          </p>

          <h3 className={styles.h3}>Auth window</h3>
          <p>
            The first two characters of the preamble are{' '}
            <strong>stable for a period of roughly 8&ndash;26 days</strong>, indicating which page
            of the on-board authentication codebook to consult. Those two characters are surfaced as
            the <em>auth window</em> on every published Message.
          </p>
        ...
        <Section num="05" title="Skyking format" eyebrow="FOXTROT BROADCAST">
          <p>
            A Skyking message is the highest-priority broadcast on the network. It is addressed to
            any airborne nuclear command element and is preceded by the unmistakable preamble{' '}
        ...
        <Section num="07" title="Skybird, Skymaster, and Mainsail traffic" eyebrow="OPERATIONAL">
          <p>
            ...
            requesting relays, passing shorthand authentication. These exchanges use{' '}
            <em>Skybird</em>, <em>Skymaster</em>, and direct callsign addressing and follow no fixed
            body template. The archive captures them as free-form text under their respective type
            tag.
          </p>
        </Section>
        ...
        <Section num="08" title="Glossary" eyebrow="Terminology">
          <dl className={styles.glossary}>
            ...
            <dd>
              Net-control signal that another EAM is queued and will be transmitted immediately
              after the current one closes. The pipeline splits chained broadcasts into individual
              Message records.
            </dd>
          </dl>
        </Section>
        ...
        <Section num="09" title="Sources" eyebrow="References">
          <p>
            ...
            operational specifics in the body of the site are recovered from broadcasted audio
            &mdash; no classified material is reproduced.
          </p>
        ...
        <Section num="10" title="Corrections welcome" eyebrow="Errata">
          <p>
            The format notes here are based on open-source research and community-reported
            intercepts. Anyone with first-hand HFGCS operating experience who spots an inaccuracy is
            invited to file an issue or open a pull request on{' '}
            <a
  ...
  return (
    <header className={styles.header}>
      <div className={styles.brandRow}>
        ...
        <span className={styles.brandTag}>ABOUT</span>
      </div>
