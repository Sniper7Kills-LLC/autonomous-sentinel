...
For your personal sandbox, the simplest path is an IAM user with `AdministratorAccess` (it's _your_ sandbox in _your_ account). Production deploys use scoped least-privilege roles — out of scope for sandbox work.
